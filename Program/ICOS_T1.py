...
#Words of the images
Word = [["","","","","","","","","","","","","","",""],
		["No","Si","Yo","Yo Quiero","Yo No Quiero","","","","","","","","","",""],
		["Cacahuates","galleta","Huevos","Manzana","Naranja","Palomitas","Papas","Sopa","Tortilla","Uvas","","","","",""],
		["Agua","Jugo","Leche","Refresco","Yogurth","","","","","","","","","",""],
		["Abrazo","Bailar","Cantar","Clasificar","Correr","Cosquillas","Dibujar","Montra a Caballo","Nadar","Pegar","Pintar","Recortar","Saltar","Estresado",""],
		["Casa Abuelos","Casa","Centro Comercial","Escuela","Heladera","Doctor","Iglesia","Alberca","Plaza","Restaurante","Supermercado","","","",""],
		["Borrador","Carrito","Colores","Cuchara","Fichas","Lapiz","Maraca","Muñeco","Pelota","Peluche","Plato","Tijeras","Vaso","",""],
		["Abuela","Abuelo","Hermano","Maestra","Mama","Papa","Terapeuta","","","","","","","",""],]
...
def SendImage(srcC,Flange,ConceptImg,SelectedConcepts,WordsC):
	...
	if (SelectedConcepts<=6):
		...
		modificar(srcC,4+SelectedConcepts,WordsC[Flange-1][ConceptImg])
		pass
	pass
...
#Flanges
Concepts1 = Button(Words, text = FName[0], image= ICon1, width=screen_width/7, height=screen_height/20, bd= -2, bg= FColor[0], command=lambda:BChange(srcActuals,FColor[0],0)).place(x=0,y=0)
Concepts2 = Button(Words, text = FName[1], image= ICon2, width=screen_width/7, height=screen_height/20, bd= -2, bg= FColor[1], command=lambda:BChange(srcActuals,FColor[1],1)).place(x=screen_width/7,y=0)
Concepts3 = Button(Words, text = FName[2], image= ICon3, width=screen_width/7, height=screen_height/20, bd= -2, bg= FColor[2], command=lambda:BChange(srcActuals,FColor[2],2)).place(x=screen_width*2/7,y=0)
Concepts4 = Button(Words, text = FName[3], image= ICon4, width=screen_width/7, height=screen_height/20, bd= -2, bg= FColor[3], command=lambda:BChange(srcActuals,FColor[3],3)).place(x=screen_width*3/7,y=0)
Concepts5 = Button(Words, text = FName[4], image= ICon5, width=screen_width/7, height=screen_height/20, bd= -2, bg= FColor[4], command=lambda:BChange(srcActuals,FColor[4],4)).place(x=screen_width*4/7,y=0)
Concepts6 = Button(Words, text = FName[5], image= ICon6, width=screen_width/7, height=screen_height/20, bd= -2, bg= FColor[5], command=lambda:BChange(srcActuals,FColor[5],5)).place(x=screen_width*5/7,y=0)
Concepts7 = Button(Words, text = FName[6], image= ICon7, width=screen_width/7, height=screen_height/20, bd= -2, bg= FColor[6], command=lambda:BChange(srcActuals,FColor[6],6)).place(x=screen_width*6/7,y=0)
...
#ConceptNames
LImg1 = Label(Words, text=Word[UbFlange(srcActuals)][0], width=int(((screen_width/7)-((screen_width/7)%7))/7), height=int(((screen_height/15)-((screen_height/15)%40))/40), bg=TxtBack, fg="black", bd= 3);LImg1.place(x=screen_width/21,y=screen_height*9/40)
LImg2 = Label(Words, text=Word[UbFlange(srcActuals)][1], width=int(((screen_width/7)-((screen_width/7)%7))/7), height=int(((screen_height/15)-((screen_height/15)%40))/40), bg=TxtBack, fg="black", bd= 3);LImg2.place(x=screen_width*5/21,y=screen_height*9/40)
LImg3 = Label(Words, text=Word[UbFlange(srcActuals)][2], width=int(((screen_width/7)-((screen_width/7)%7))/7), height=int(((screen_height/15)-((screen_height/15)%40))/40), bg=TxtBack, fg="black", bd= 3);LImg3.place(x=screen_width*9/21,y=screen_height*9/40)
LImg4 = Label(Words, text=Word[UbFlange(srcActuals)][3], width=int(((screen_width/7)-((screen_width/7)%7))/7), height=int(((screen_height/15)-((screen_height/15)%40))/40), bg=TxtBack, fg="black", bd= 3);LImg4.place(x=screen_width*13/21,y=screen_height*9/40)
LImg5 = Label(Words, text=Word[UbFlange(srcActuals)][4], width=int(((screen_width/7)-((screen_width/7)%7))/7), height=int(((screen_height/15)-((screen_height/15)%40))/40), bg=TxtBack, fg="black", bd= 3);LImg5.place(x=screen_width*17/21,y=screen_height*9/40)
LImg6 = Label(Words, text=Word[UbFlange(srcActuals)][5], width=int(((screen_width/7)-((screen_width/7)%7))/7), height=int(((screen_height/15)-((screen_height/15)%40))/40), bg=TxtBack, fg="black", bd= 3);LImg6.place(x=screen_width/21,y=screen_height*17/40)
LImg7 = Label(Words, text=Word[UbFlange(srcActuals)][6], width=int(((screen_width/7)-((screen_width/7)%7))/7), height=int(((screen_height/15)-((screen_height/15)%40))/40), bg=TxtBack, fg="black", bd= 3);LImg7.place(x=screen_width*5/21,y=screen_height*17/40)
LImg8 = Label(Words, text=Word[UbFlange(srcActuals)][7], width=int(((screen_width/7)-((screen_width/7)%7))/7), height=int(((screen_height/15)-((screen_height/15)%40))/40), bg=TxtBack, fg="black", bd= 3);LImg8.place(x=screen_width*9/21,y=screen_height*17/40)
LImg9 = Label(Words, text=Word[UbFlange(srcActuals)][8], width=int(((screen_width/7)-((screen_width/7)%7))/7), height=int(((screen_height/15)-((screen_height/15)%40))/40), bg=TxtBack, fg="black", bd= 3);LImg9.place(x=screen_width*13/21,y=screen_height*17/40)
LImg10 = Label(Words, text=Word[UbFlange(srcActuals)][9], width=int(((screen_width/7)-((screen_width/7)%7))/7), height=int(((screen_height/15)-((screen_height/15)%40))/40), bg=TxtBack, fg="black", bd= 3);LImg10.place(x=screen_width*17/21,y=screen_height*17/40)
LImg11 = Label(Words, text=Word[UbFlange(srcActuals)][10], width=int(((screen_width/7)-((screen_width/7)%7))/7), height=int(((screen_height/15)-((screen_height/15)%40))/40), bg=TxtBack, fg="black", bd= 3);LImg11.place(x=screen_width/21,y=screen_height*25/40)
LImg12 = Label(Words, text=Word[UbFlange(srcActuals)][11], width=int(((screen_width/7)-((screen_width/7)%7))/7), height=int(((screen_height/15)-((screen_height/15)%40))/40), bg=TxtBack, fg="black", bd= 3);LImg12.place(x=screen_width*5/21,y=screen_height*25/40)
LImg13 = Label(Words, text=Word[UbFlange(srcActuals)][12], width=int(((screen_width/7)-((screen_width/7)%7))/7), height=int(((screen_height/15)-((screen_height/15)%40))/40), bg=TxtBack, fg="black", bd= 3);LImg13.place(x=screen_width*9/21,y=screen_height*25/40)
LImg14 = Label(Words, text=Word[UbFlange(srcActuals)][13], width=int(((screen_width/7)-((screen_width/7)%7))/7), height=int(((screen_height/15)-((screen_height/15)%40))/40), bg=TxtBack, fg="black", bd= 3);LImg14.place(x=screen_width*13/21,y=screen_height*25/40)
LImg15 = Label(Words, text=Word[UbFlange(srcActuals)][14], width=int(((screen_width/7)-((screen_width/7)%7))/7), height=int(((screen_height/15)-((screen_height/15)%40))/40), bg=TxtBack, fg="black", bd= 3);LImg15.place(x=screen_width*17/21,y=screen_height*25/40)
...
#Configuration
ConfigButton = Button(Sentence, text="o", width=int(screen_width/400), height=int(((screen_height/15)-((screen_height/15)%40))/40), bd= -2, command= lambda:Configure(), bg="white");ConfigButton.place(x=screen_width*40/42,y=screen_height*10/80)
